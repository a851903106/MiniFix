...
struct DirStruct
{
	...
	value_type value16() const
	{
		return this->value<4>();
	}

	void value16(value_type value)
	{
		this->value<4>(value);
	}
	...
	value_type value64() const
	{
		return this->value<6>();
	}

	void value64(value_type value)
	{
		this->value<6>(value);
	}
	
	value_type value128() const
	{
		return this->value<7>();
	}

	void value128(value_type value)
	{
		this->value<7>(value);
	}
	...
	value_type value512() const
	{
		return this->value<9>();
	}

	void value512(value_type value)
	{
		this->value<9>(value);
	}
